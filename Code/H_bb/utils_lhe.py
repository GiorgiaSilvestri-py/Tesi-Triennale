...
#lhe level version
def build_decay_products(events_dict):
...
def ROOT_hist1d(list1, list2, var, axis_name, nbins, xmin = None, xmax = None):
        ...
        hist1 = ROOT.TH1F("hist1", f"{var} distribution", nbins, xmin, xmax)
        hist2 = ROOT.TH1F("hist2", f"{var} distribution", nbins, xmin, xmax)
        ...
        canvas.SaveAs(f"{var} distribution")
