...
def main():
    ...
    ROOT_hist1d(pt_h_l_list, pt_h_t_list, "Higgs transverse momentum", "pt (GeV)")
    ROOT_hist1d(eta_h_l_list, eta_h_t_list, "Higgs pseudorapidity", "eta")
    ROOT_hist1d(phi_h_l_list, phi_h_t_list, "Higgs phi", "phi (rad)")
